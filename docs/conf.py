# -*- coding: ISO-8859-15 -*-
#
# Text Preprocess and Normalization Library configuration file, 
# created by mixturing the conf.py files of Orange, django-oscar and sklearn
#
...
extensions = ['sphinx.ext.autodoc',
            'sphinxcontrib.napoleon', #render Google and numpy doc style docstring
...
exclude_patterns = ['.ipynb_checkpoints','notebooks']
...
issues_github_path = 'sorice/preprocess'
...
# of the sidebar.
html_logo = "_static/preprocess.png"
...
htmlhelp_basename = 'preprocess-doc'
...
#latex_documents = [
#  ('index', 'preprocess-doc.tex', u'Preprocess Documentation',
